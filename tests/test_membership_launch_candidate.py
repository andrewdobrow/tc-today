...
def test_subscribe_page_is_real_landing_page_not_account_gate():
    ...
    assert '/membership.css?v=1.13.9.31' in page
    assert '/membership.js?v=1.13.9.31' in page
...
def test_sitewide_subscriber_chrome_loads_membership_state_and_prepaints(tmp_path, monkeypatch):
    ...
    assert 'src="/membership.js?v=1.13.9.31"' in rendered
    assert rendered.count('/membership.js?v=1.13.9.31') == 1
