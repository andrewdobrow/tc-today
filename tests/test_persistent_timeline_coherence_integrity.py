...
def test_registry_repair_splits_only_incompatible_component_and_is_idempotent():
    ...
    assert first.repair_version == REPAIR_VERSION == 10
...
def test_production_registry_has_no_incoherent_timelines_and_repairs_exact_cases():
    ...
    pairs = [
        (
            "https://www.wptv.com/news/treasure-coast/region-martin-county/martin-county-fire-rescue-could-lose-16-5m-if-property-tax-reform-passes-in-november",
            "https://www.wptv.com/news/palm-beach-county-region-the-glades/2-killed-2-seriously-hurt-in-three-vehicle-crash-involving-semi-truck-near-belle-glade",
        ),
        (
            "https://www.wptv.com/news/local-news/our-community/west-palm-beach/cat-hamster-rescued-after-house-fire-in-palm-beach-county",
            "https://www.wptv.com/news/region-martin-county/indiantown/indian-river-county-firefighter-paramedic-dies-following-off-duty-personal-tragedy",
        ),
        (
            "https://www.wptv.com/news/region-c-palm-beach-county/riviera-beach/riviera-beach-police-officer-arrested-on-dui-charge-in-loxahatchee-pbso-says",
            "https://www.wptv.com/news/region-c-palm-beach-county/loxahatchee-acreage/1-dead-after-reported-shooting-in-loxahatchee-groves-fire-rescue-says",
        ),
    ]
